                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Inserta los nuevos datos</li>
                        </ol>

                        <?php

require_once 'model/EliminarEventoModel.php';

// Verificar si se ha pasado el parámetro IDEventos en la URL
if (!isset($_GET['IDEventos'])) {
    echo "No se ha proporcionado el ID del evento a eliminar.";
    exit();
}

$idEvento = $_GET['IDEventos'];
$model = new EliminarEventoModel();

$titulo = $model->getEventoTitulo($idEvento);

if ($titulo) {
    // Mostrar el mensaje de confirmación
    echo "¿Estás seguro de que deseas eliminar el evento '$titulo'?<br>";
    echo "<form method='POST'>";
    echo "<input type='submit' value='Eliminar'>";
    echo "</form>";

    if ($model->eliminarEvento($idEvento)) {
        echo "Evento eliminado correctamente.";
        echo "<script>window.location.href = 'indexadm.php';</script>"; // Redireccionar a indexadm.php después de eliminar el evento
        exit();
    }
} else {
